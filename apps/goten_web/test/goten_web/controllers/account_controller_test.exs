defmodule GotenWeb.AccountControllerTest do
  use GotenWeb.ConnCase

  alias Goten.Accounts

  @create_attrs %{active: true, code: "some code", creator_user_id: 42, description: "some description", modifier_user_id: 42, name: "some name", nature: "some nature"}
